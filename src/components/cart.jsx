  ...
  return (
    <Offcanvas show={show} onHide={handleClose}>
      <Offcanvas.Header closeButton>
        <Offcanvas.Title style={{ display: 'flex', gap: '7rem', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }} ><i className="fa-solid fa-cart-plus"></i> CART SHOP</Offcanvas.Title>
      </Offcanvas.Header>
      <Offcanvas.Body>
